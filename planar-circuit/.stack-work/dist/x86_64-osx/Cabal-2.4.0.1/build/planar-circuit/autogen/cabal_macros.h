...
/* package planar-circuit-0.1.0.0 */
#ifndef VERSION_planar_circuit
#define VERSION_planar_circuit "0.1.0.0"
#endif /* VERSION_planar_circuit */
#ifndef MIN_VERSION_planar_circuit
#define MIN_VERSION_planar_circuit(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_planar_circuit */
...
#define CURRENT_COMPONENT_ID "planar-circuit-0.1.0.0-BbmvEdEuTyiITVk8DGPllz-planar-circuit"
